...
RUBRIC: tuple[MissionRubric, ...] = (
    MissionRubric(
        ...
        checks=(
            ...
            Check(
                path=("answer", "evidence_map", "loan_case_debug"),
                points=2,
                label="Loan evidence identifies artifact, case, and SHAP values",
                all_of=("loan_risk_casebook.json", "c-104", "shap_values"),
            ),
            Check(
                path=("answer", "evidence_map", "support_bot_wrong_answer"),
                points=2,
                label="Support evidence identifies artifact, trace, and bad span",
                all_of=("support_bot_traces.json", "trace-003", "retrieval"),
            ),
            Check(
                path=("answer", "evidence_map", "leakage_feature_audit"),
                points=1,
                label="Leakage evidence identifies artifact, section, and feature",
                all_of=(
            ...
            Check(
                path=("answer", "shared_failure_mode_code"),
                points=1,
                label="Shared failure mode is a wrong output needing artifact evidence",
                any_of=(
                    "wrong_output_needs_artifact_evidence",
                    "wrong outcome needs artifact evidence",
                ),
            ),
            Check(
                path=("answer", "evidence_count"),
                points=1,
                label="Evidence count covers all three debugging jobs",
                any_of=("3",),
            ),
        ),
    ),
